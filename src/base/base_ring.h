...
internal void *ring_try_push(Ring *ring, U64 size);
internal void *ring_try_pop(Ring *ring, U64 size);
...
internal void *guarded_ring_try_push(RingGuard *guard, U64 size);
internal void *guarded_ring_try_pop(RingGuard *guard, U64 size);
...
internal void *guarded_ring_push_or_wait(RingGuard *guard, U64 size, U64 endt_us);
internal void *guarded_ring_pop_or_wait(RingGuard *guard, U64 size, U64 endt_us);
