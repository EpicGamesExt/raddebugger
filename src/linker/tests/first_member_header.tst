test:
{
  ...
  build:
  {
    link:
    {
      args: "/RAD_MEMORY_MAP_FILES:READ_WRITE /subsystem:console /entry:entry /out:a.exe test.lib entry.obj /include:1 /include:2 /include:3 /include:4 /include:5 /include:6 /include:7 /include:8 /include:9"
    }
  }

  steps:
  {
    expect_file: { path: "test.lib", equals_artifact: test_lib }
    expect_file: { path: "entry.obj", equals_artifact: entry_obj }
  }
}
