test:
{
    ...
    debug_obj:
    {
      ...
      coff: { object:
      {
        ...
        sections:
        {
          ...
          debug_h: { name: ".debug$H", permissions: (read), content: initialized_data, flags: (discardable), data: { hex: "c5c9330100000100a5fdf48ae0caba6e9a76f994668785c388229ba829a5a87e" } }
        }
      } }
    }
    entry_obj:
  ...
  build:
  {
    link:
    {
      ...
      output: none
      stderr_matches: "*Warning(*): *: mismatched .debug$H hash algorithm: got SHA1_8, expected *"
    }
  }
  steps: {}
}
