test:
{
    ...
    debug_obj:
    {
      ...
      coff: { object:
      {
        ...
        sections:
        {
          ...
          debug_h: { name: ".debug$H", permissions: (read), content: initialized_data, flags: (discardable), data: { hex: "7b00000000000200a5fdf48ae0caba6e9a76f994668785c388229ba829a5a87e" } }
        }
      } }
    }
    entry_obj:
  ...
  build:
  {
    link:
    {
      ...
      output: none
      stderr_matches: "*Warning(*): *: .debug$H contains invalid magic: got 0x7b, expected 0x133c9c5*"
    }
  }
  steps: {}
}
