test:
{
  artifacts:
  {
    object:
    {
      file_name: "icf_pdata_xdata_fold.obj"
      coff: { object:
      {
        machine: x64
        sections:
        {
          ...
          pdata_a:
          {
            ...
            alignment: 4
            flags: (link_comdat)
            data: { hex: "000000000000000000000000" }
            relocations:
            {
              first: { type: Addr32Nb, offset: 0, symbol: fn_a_symbol }
              last: { type: Addr32Nb, offset: 4, symbol: fn_a_symbol }
              unwind: { type: Addr32Nb, offset: 8, symbol: unwind_a }
            }
          }
          pdata_b:
          {
            ...
            relocations:
            {
              first: { type: Addr32Nb, offset: 0, symbol: fn_b_symbol }
              last: { type: Addr32Nb, offset: 4, symbol: fn_b_symbol }
              unwind: { type: Addr32Nb, offset: 8, symbol: unwind_b }
            }
          }
          addresses:
          {
            ...
            relocations:
            {
              ...
              unwind_b: { type: Addr64, offset: 24, symbol: unwind_b }
            }
          }
        }
        symbols:
  ...
  build: { link: { args: "/subsystem:console /entry:entry /out:a.exe /opt:ref,icf /include:addresses icf_pdata_xdata_fold.obj", artifact: image } }
  steps:
  {
