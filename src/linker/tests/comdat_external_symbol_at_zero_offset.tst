test:
{
  artifacts:
  {
    leader_obj:
    {
      ...
      {
        machine: x64
        sections: { data: { name: ".rdata", permissions: (read), content: initialized_data, alignment: 8, flags: (link_comdat), data: { zero: 8 } } }
        symbols:
        {
    ...
    ref_obj:
    {
      ...
      coff: { object:
      {
        ...
        sections:
        {
          data: { name: ".rdata", permissions: (read), content: initialized_data, alignment: 8, flags: (link_comdat), data: { zero: 8 } }
          ptr:
          {
            name: ".data"
  ...
  steps:
  {
    ...
    expect_pe_word: { artifact: image, section: ".data", offset: 0, type: u64, target_section: ".rdata", target_offset: 0 }
    expect_pe_word: { artifact: image, section: ".text", offset: 3, type: rel32, target_section: ".rdata", target_offset: 0 }
  }
}
