...
#define RD_VIEW_SETUP_FUNCTION_SIG(name) void name(RD_View *view, MD_Node *params, String8 string)
#define RD_VIEW_SETUP_FUNCTION_NAME(name) rd_view_setup_##name
